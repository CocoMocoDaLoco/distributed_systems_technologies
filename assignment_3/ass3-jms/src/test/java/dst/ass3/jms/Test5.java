...
public class Test5 extends AbstractJMSTest {
    ...
    @Test
    public void test_AssignRateAndProcess2() {
        sem = new Semaphore(0);
        ...
        IComputerListener computerListener = new IComputerListener() {
            ...
            public void waitTillProcessed(ProcessTaskDTO task,
                ...
                assertEquals("computerName", "pc2", computerName);
                assertEquals("taskcomplexity", TaskComplexity.EASY,
                        acceptedComplexity);
            ...
            public void notify(InfoType type, TaskDTO task) {
                ...
                case 1:
                    ...
                    assertEquals("2nd event != ASSIGNED", TaskStatus.PROCESSED,
                            task.getStatus());
                    assertEquals("2nd event complexity ", TaskComplexity.EASY,
                            task.getComplexity());
                ...
                case 2:
                    ...
                    assertEquals("3rd event != ASSIGNED", TaskStatus.PROCESSED,
                            task.getStatus());
                    assertEquals("3rd event complexity ", TaskComplexity.EASY,
                            task.getComplexity());
        ...
        assure(sem, 1, "did not get 1 event (Scheduler: info) in time", DEFAULT_CHECK_TIMEOUT);
