...
public class TestData {
	...
	protected Long admin1Id;
	protected Long admin2Id;

	protected Long user1Id;
	protected Long user2Id;

	protected Long computer1Id;
	protected Long computer2Id;
	protected Long computer3Id;

	protected Long cluster1Id;
	protected Long cluster2Id;

	protected Long job1Id;
	protected Long job2Id;
	protected Long job3Id;
