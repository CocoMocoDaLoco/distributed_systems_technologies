...
/* Note: The only difference to the InjectionController is that this controller doesn't
 * call initialize(instance) after creating a new instance, since we've already messed
 * with that instances ctor. */
